...
def test_collect_candidates( codeCompletionCore, tokenIndex ) -> None:
    """
    Test collected candidates for 'var c = a + b()' at tokenIndex

    :param codeCompletionCore: test fixture
    :param tokenIndex: tokenIndex from caret
    :return:
    """
    candidates = codeCompletionCore.collectCandidates( tokenIndex )
    match tokenIndex:
        # At the input start.
        case 0:
