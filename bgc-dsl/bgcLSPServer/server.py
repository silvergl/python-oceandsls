...
example_server = bgcLSPServer( 'pygls-odsl-bgc-prototype', 'v0.1' )
...
def completions(params: Optional[CompletionParams] = None) -> CompletionList:
    ...
    parseTree: Top_levelContext = example_server.parser.bgcModel()
...
@example_server.feature( TEXT_DOCUMENT_SEMANTIC_TOKENS_FULL,
...
@example_server.command( bgcLSPServer.CMD_PROGRESS )
...
@example_server.command( bgcLSPServer.CMD_REGISTER_COMPLETIONS )
...
@example_server.command( bgcLSPServer.CMD_UNREGISTER_COMPLETIONS )
