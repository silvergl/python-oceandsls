...
public class TestSuiteParser extends Parser {
	...
	public static final int
		...
		T__80=81, ID=82, STRING=83, COMMENT=84, INT=85, NUM=86, DP=87, TDD_COMMENT=88, 
		NEWLINE=89, WS=90;
	public static final int
		...
		RULE_test_module = 8, RULE_test_assertion = 9, RULE_test_input = 10, RULE_test_output = 11, 
		RULE_parameter = 12, RULE_optionalDesc = 13, RULE_optionalComment = 14, 
		RULE_parameterDeclaration = 15, RULE_f90StdKey = 16, RULE_directive = 17, 
		...
		RULE_expr = 26, RULE_reference = 27, RULE_exprList = 28, RULE_unitSpec = 29, 
		RULE_composedUnit = 30, RULE_basicUnit = 31, RULE_siUnit = 32, RULE_customUnit = 33, 
		RULE_unitPrefix = 34, RULE_siType = 35;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"test_input", "test_output", "parameter", "optionalDesc", "optionalComment", 
			"parameterDeclaration", "f90StdKey", "directive", "paramType", "typeRef", 
			"enumType", "enum", "arrayType", "dim", "sizeDim", "rangeDim", "expr", 
			"reference", "exprList", "unitSpec", "composedUnit", "basicUnit", "siUnit", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'modules'", "'assert'", "'('", "')'", "'in'", "'out'", "'DIMENSION'", 
			"'INTENT(IN)'", "'INTENT(INOUT)'", "'INTENT(OUT)'", "'PARAMETER'", "'Equal'", 
	...
	public final Test_varContext test_var() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==T__9 || ((((_la - 82)) & ~0x3f) == 0 && ((1L << (_la - 82)) & 59L) != 0)) {
				{
				setState(108);
				expr(0);
				}
	...
	public final Test_inputContext test_input() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_test_input);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( _la==T__9 || ((((_la - 82)) & ~0x3f) == 0 && ((1L << (_la - 82)) & 59L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Test_outputContext test_output() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_test_output);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final F90StdKeyContext f90StdKey() throws RecognitionException {
		...
		try {
			...
			case T__13:
				...
				{
				setState(203);
				((ArraySpecContext)_localctx).keyword = match(T__13);
				}
				break;
			case T__14:
				...
				{
				setState(204);
				((ArgSpecInputContext)_localctx).keyword = match(T__14);
				}
				break;
			case T__15:
				...
				{
				setState(205);
				((ArgSpecInOutputContext)_localctx).keyword = match(T__15);
				}
				break;
			case T__16:
				...
				{
				setState(206);
				((ArgSpecOutputContext)_localctx).keyword = match(T__16);
				}
				break;
			case T__17:
				...
				{
				setState(207);
				((ConstantSpecContext)_localctx).keyword = match(T__17);
				}
				break;
			case STRING:
	...
	public final UnitSpecContext unitSpec() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_unitSpec);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ComposedUnitContext composedUnit() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_composedUnit);
		try {
			setState(341);
			_errHandler.sync(this);
	...
	public final BasicUnitContext basicUnit() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_basicUnit);
		try {
			setState(349);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final SiUnitContext siUnit() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_siUnit);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(352);
	...
	public final CustomUnitContext customUnit() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_customUnit);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(356);
	...
	public final UnitPrefixContext unitPrefix() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_unitPrefix);
		try {
			setState(383);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
			case T__47:
				...
				{
				setState(358);
				((UnitPrefixContext)_localctx).noP = match(T__47);
				}
				break;
			case T__48:
				enterOuterAlt(_localctx, 2);
				{
				setState(359);
				((UnitPrefixContext)_localctx).quetta = match(T__48);
				}
				break;
			case T__49:
				enterOuterAlt(_localctx, 3);
				{
				setState(360);
				((UnitPrefixContext)_localctx).ronna = match(T__49);
				}
				break;
			case T__50:
				enterOuterAlt(_localctx, 4);
				{
				setState(361);
				((UnitPrefixContext)_localctx).yotta = match(T__50);
				}
				break;
			case T__51:
				enterOuterAlt(_localctx, 5);
				{
				setState(362);
				((UnitPrefixContext)_localctx).zetta = match(T__51);
				}
				break;
			case T__52:
				enterOuterAlt(_localctx, 6);
				{
				setState(363);
				((UnitPrefixContext)_localctx).exa = match(T__52);
				}
				break;
			case T__53:
				enterOuterAlt(_localctx, 7);
				{
				setState(364);
				((UnitPrefixContext)_localctx).peta = match(T__53);
				}
				break;
			case T__54:
				enterOuterAlt(_localctx, 8);
				{
				setState(365);
				((UnitPrefixContext)_localctx).tera = match(T__54);
				}
				break;
			case T__55:
				enterOuterAlt(_localctx, 9);
				{
				setState(366);
				((UnitPrefixContext)_localctx).giga = match(T__55);
				}
				break;
			case T__56:
				enterOuterAlt(_localctx, 10);
				{
				setState(367);
				((UnitPrefixContext)_localctx).mega = match(T__56);
				}
				break;
			case T__57:
				enterOuterAlt(_localctx, 11);
				{
				setState(368);
				((UnitPrefixContext)_localctx).kilo = match(T__57);
				}
				break;
			case T__58:
				enterOuterAlt(_localctx, 12);
				{
				setState(369);
				((UnitPrefixContext)_localctx).hecto = match(T__58);
				}
				break;
			case T__59:
				enterOuterAlt(_localctx, 13);
				{
				setState(370);
				((UnitPrefixContext)_localctx).deca = match(T__59);
				}
				break;
			case T__60:
				enterOuterAlt(_localctx, 14);
				{
				setState(371);
				((UnitPrefixContext)_localctx).deci = match(T__60);
				}
				break;
			case T__61:
				enterOuterAlt(_localctx, 15);
				{
				setState(372);
				((UnitPrefixContext)_localctx).centi = match(T__61);
				}
				break;
			case T__62:
				enterOuterAlt(_localctx, 16);
				{
				setState(373);
				((UnitPrefixContext)_localctx).mili = match(T__62);
				}
				break;
			case T__63:
				enterOuterAlt(_localctx, 17);
				{
				setState(374);
				((UnitPrefixContext)_localctx).micro = match(T__63);
				}
				break;
			case T__64:
				enterOuterAlt(_localctx, 18);
				{
				setState(375);
				((UnitPrefixContext)_localctx).nano = match(T__64);
				}
				break;
			case T__65:
				enterOuterAlt(_localctx, 19);
				{
				setState(376);
				((UnitPrefixContext)_localctx).pico = match(T__65);
				}
				break;
			case T__66:
				enterOuterAlt(_localctx, 20);
				{
				setState(377);
				((UnitPrefixContext)_localctx).femto = match(T__66);
				}
				break;
			case T__67:
				enterOuterAlt(_localctx, 21);
				{
				setState(378);
				((UnitPrefixContext)_localctx).atto = match(T__67);
				}
				break;
			case T__68:
				enterOuterAlt(_localctx, 22);
				{
				setState(379);
				((UnitPrefixContext)_localctx).zepto = match(T__68);
				}
				break;
			case T__69:
				...
				{
				setState(380);
				((UnitPrefixContext)_localctx).yocto = match(T__69);
				}
				break;
			case T__70:
				...
				{
				setState(381);
				((UnitPrefixContext)_localctx).ronto = match(T__70);
				}
				break;
			case T__71:
				...
				{
				setState(382);
				((UnitPrefixContext)_localctx).quecto = match(T__71);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final SiTypeContext siType() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_siType);
		try {
			setState(395);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
			case T__72:
				...
				{
				setState(385);
				((SiTypeContext)_localctx).second = match(T__72);
				}
				break;
			case T__62:
				enterOuterAlt(_localctx, 2);
				{
				setState(386);
				((SiTypeContext)_localctx).metre = match(T__62);
				}
				break;
			case T__73:
				enterOuterAlt(_localctx, 3);
				{
				setState(387);
				((SiTypeContext)_localctx).gram = match(T__73);
				}
				break;
			case T__74:
				enterOuterAlt(_localctx, 4);
				{
				setState(388);
				((SiTypeContext)_localctx).ampere = match(T__74);
				}
				break;
			case T__75:
				enterOuterAlt(_localctx, 5);
				{
				setState(389);
				((SiTypeContext)_localctx).kelvin = match(T__75);
				}
				break;
			case T__76:
				enterOuterAlt(_localctx, 6);
				{
				setState(390);
				((SiTypeContext)_localctx).mole = match(T__76);
				}
				break;
			case T__77:
				enterOuterAlt(_localctx, 7);
				{
				setState(391);
				((SiTypeContext)_localctx).candela = match(T__77);
				}
				break;
			case T__78:
				enterOuterAlt(_localctx, 8);
				{
				setState(392);
				((SiTypeContext)_localctx).pascal = match(T__78);
				}
				break;
			case T__79:
				enterOuterAlt(_localctx, 9);
				{
				setState(393);
				((SiTypeContext)_localctx).joule = match(T__79);
				}
				break;
			case T__80:
				enterOuterAlt(_localctx, 10);
				{
				setState(394);
				((SiTypeContext)_localctx).ton = match(T__80);
				}
				break;
			default:
				throw new NoViableAltException(this);
