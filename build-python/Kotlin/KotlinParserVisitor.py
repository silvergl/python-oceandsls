...
class KotlinParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by KotlinParser#variableRead.
    def visitVariableRead(self, ctx:KotlinParser.VariableReadContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by KotlinParser#suggestArgument.
    def visitSuggestArgument(self, ctx:KotlinParser.SuggestArgumentContext):
        return self.visitChildren(ctx)
