...
class KotlinParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by KotlinParser#variableRead.
    def enterVariableRead(self, ctx:KotlinParser.VariableReadContext):
        pass

    # Exit a parse tree produced by KotlinParser#variableRead.
    def exitVariableRead(self, ctx:KotlinParser.VariableReadContext):
        pass
    ...
    # Enter a parse tree produced by KotlinParser#suggestArgument.
    def enterSuggestArgument(self, ctx:KotlinParser.SuggestArgumentContext):
        pass

    # Exit a parse tree produced by KotlinParser#suggestArgument.
    def exitSuggestArgument(self, ctx:KotlinParser.SuggestArgumentContext):
        pass
