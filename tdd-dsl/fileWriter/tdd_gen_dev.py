...
def write_tdd(list_tests: List[TestCase], template_path: str = 'templates/tdd/dev', template_files: List[str] = ['tdd_pf_template.txt','tdd_module_template.txt','tdd_assertion_template.txt'],
