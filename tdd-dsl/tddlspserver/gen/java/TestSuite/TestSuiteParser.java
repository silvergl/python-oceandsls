...
public class TestSuiteParser extends Parser {
	...
	public static final int
		...
		RULE_test_var = 4, RULE_varDeclaration = 5, RULE_use_modules = 6, RULE_test_module = 7, 
		RULE_test_assertion = 8, RULE_pubAttributes = 9, RULE_test_parameter = 10, 
		RULE_optionalDesc = 11, RULE_optionalComment = 12, RULE_parameterDeclaration = 13, 
		RULE_f90StdKey = 14, RULE_test_directive = 15, RULE_paramType = 16, RULE_typeRef = 17, 
		RULE_enumType = 18, RULE_enum = 19, RULE_arrayType = 20, RULE_dim = 21, 
		RULE_sizeDim = 22, RULE_rangeDim = 23, RULE_expr = 24, RULE_reference = 25, 
		RULE_unitSpec = 26, RULE_composedUnit = 27, RULE_basicUnit = 28, RULE_siUnit = 29, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"use_modules", "test_module", "test_assertion", "pubAttributes", "test_parameter", 
			"optionalDesc", "optionalComment", "parameterDeclaration", "f90StdKey", 
			"test_directive", "paramType", "typeRef", "enumType", "enum", "arrayType", 
			"dim", "sizeDim", "rangeDim", "expr", "reference", "unitSpec", "composedUnit", 
	...
	public final Use_modulesContext use_modules() throws RecognitionException {
		...
		enterRule(_localctx, 12, RULE_use_modules);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Test_moduleContext test_module() throws RecognitionException {
		...
		enterRule(_localctx, 14, RULE_test_module);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(139);
	...
	public final Test_assertionContext test_assertion() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_test_assertion);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final PubAttributesContext pubAttributes() throws RecognitionException {
		...
		enterRule(_localctx, 18, RULE_pubAttributes);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Test_parameterContext test_parameter() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_test_parameter);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(181);
	...
	public final OptionalDescContext optionalDesc() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_optionalDesc);
		try {
			setState(191);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final OptionalCommentContext optionalComment() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_optionalComment);
		try {
			setState(195);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final F90StdKeyContext f90StdKey() throws RecognitionException {
		...
		enterRule(_localctx, 28, RULE_f90StdKey);
		try {
			setState(212);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Test_directiveContext test_directive() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_test_directive);
		try {
			setState(237);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final SizeDimContext sizeDim() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_sizeDim);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final RangeDimContext rangeDim() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_rangeDim);
		try {
			setState(288);
			_errHandler.sync(this);
	...
	public final UnitSpecContext unitSpec() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_unitSpec);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ComposedUnitContext composedUnit() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_composedUnit);
		try {
			setState(346);
			_errHandler.sync(this);
	...
	public final BasicUnitContext basicUnit() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_basicUnit);
		try {
			setState(354);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
